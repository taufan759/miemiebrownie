                ...
                <div class="edit-profile__text">
                    ...
                    <form action="{{ route('customer.updateProfile') }}" method="POST" class="space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" name="nama" class="form-control" value="{{ $customer->nama }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="hp" name="hp" class="form-control" value="{{ $customer->hp }}">
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat</label>
                            <input type="text" id="alamat" name="alamat" class="form-control" value="{{ $customer->alamat }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sosmed" name="sosmed" class="form-control" value="{{ $customer->sosmed }}">
                        </div>
                        <div class="form-group">
